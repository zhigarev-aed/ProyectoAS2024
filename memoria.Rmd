...
```{r,echo=FALSE, eval = TRUE, out.height="30%"}
...
```{r,echo=FALSE, eval = TRUE, out.height="30%", out.width="100%"}
...
En los casos de ruido tipo 'salt and pepper' y uniforme, se observa que el ruido se elimina usando universal, sin embargo en FDR se mantiene.
...
El umbral Universal emplea un valor fijo basado en el tamaño de la señal, lo que limita su capacidad para capturar completamente la variabilidad del ruido. En contraste, FDR estima la probabilidad de que un coeficiente wavelet provenga del ruido, lo que le permite adaptarse mejor a las características específicas de la señal. Como resultado, FDR puede ofrecer una eliminación de ruido más adaptativa y suave, preservando mejor los detalles de la imagen. sin embargo esto provoca que el ruido no sea completamente eliminado en las imagenes.
