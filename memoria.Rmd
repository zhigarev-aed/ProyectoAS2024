...
```{r}
gaussian_noise_1<-add_noise_to_image("1", "gaussian", list(std_dev = 0.3))
sinosuidal_high_noise_2<-add_noise_to_image("2", "sinusoidal_high", list(frequency = 25, amplitude = 0.2))
sinosuidal_low_noise_3<-add_noise_to_image("3", "sinusoidal_low", list(frequency = 2, amplitude = 0.2))
salt_pepper_noise_4<-add_noise_to_image("4", "salt_pepper", list(epsilon = 0.1))
...
```{r}
imagen_noise <- list(gaussian_noise_1, sinosuidal_high_noise_2, sinosuidal_low_noise_3)
names(imagen_noise) <- c('1 Noise: gaussian', '2 Noise: sinusoidal high', '3 Noise: sinusoidal low')
...
```{r}
#foto_cuadrada <- hacer_cuadrada(images[[5]])
foto_cuadrada <- hacer_cuadrada(gaussian_noise_1)
